...
def main() -> int:
    ...
    try:
        wait_for_server()
        tool_call("enable_tools", {"tools": ["get_current_scene", "get_debugger_sessions", "get_runtime_info", "get_runtime_performance_snapshot", "install_runtime_probe", "list_open_scenes", "open_scene", "run_project", "stop_project"], "enabled": True}, request_id=90)
