...
def main() -> int:
    ...
    try:
        wait_for_server()
        tool_call("enable_tools", {"tools": ["create_runtime_node", "delete_runtime_node", "evaluate_runtime_expression", "get_current_scene", "get_debugger_messages", "get_debugger_sessions", "get_runtime_info", "install_runtime_probe", "open_scene", "run_project", "stop_project"], "enabled": True}, request_id=90)
