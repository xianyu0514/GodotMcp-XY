...
answers an AI needs before it can do any work:
  ...
  initialize           -> protocol answer + accurate instructions (243-tool truth)
...
def main() -> int:
    ...
    try:
        ...
        check("instructions cite 243-tool truth", "243-tool catalog" in instructions, instructions[:120])
        ...
        check("24 recipes registered", len(prompts) == 24, f"{len(prompts)}: {sorted(prompt_names)}")
