...
def main() -> int:
    ...
    try:
        wait_for_server()
        tool_call("enable_tools", {"tools": ["clear_runtime_theme_override", "get_current_scene", "get_debugger_messages", "get_debugger_sessions", "get_runtime_info", "get_runtime_theme_item", "install_runtime_probe", "open_scene", "run_project", "set_runtime_theme_override", "stop_project"], "enabled": True}, request_id=90)
