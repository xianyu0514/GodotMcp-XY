...
func test_all_enables_everything():
	...
	assert_eq(_count_enabled(states), 245, "all preset should enable 245 tools")
...
func test_debugging_includes_core_plus_debug_advanced():
	...
	assert_eq(_count_enabled(states), 110, "debugging = 28 core + 6 meta + 76 Debug-Advanced")
...
func test_level_design_enables_authoring_groups():
	...
	assert_eq(_count_enabled(states), 85, "level_design = 28 core + 6 meta + 8 + 9 + 11 + 23 advanced authoring tools")
