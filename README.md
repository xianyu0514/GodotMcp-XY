...
[![Tools](https://img.shields.io/badge/MCP%20tools-209-blue.svg)](docs/tools/README.md)
...
- **209 tools, sensibly scoped** — 30 high-value *core* tools are on by default; 177 more
...
The plugin exposes **209 tools** in six categories (plus 2 always-on *meta* tools for tool discovery). Each links to a full, per-tool reference.
...
| [Debug & Runtime](docs/tools/debug-tools.md) | 73 | Logs, debugger, breakpoints, profilers, live runtime control |
| [Project](docs/tools/project-tools.md) | 56 | Settings, resources, input map, audits, 4.7 migration, asset generation, task plan |
...
Only the 30 **core** tools (plus 2 always-on **meta** tools) are enabled by default — enable any of the 177 **advanced** tools
