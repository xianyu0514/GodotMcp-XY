...
- **233 tools with a small default surface:** 28 core tools are enabled immediately, 199 advanced tools remain on demand, and 6 meta tools cover discovery plus durable complete-game workflows.
...
| [Script](docs/tools/script-tools.md) | 19 | 6 | 13 | Read/write/patch/validate GDScript and C#, shader validation, search, symbols and references |
