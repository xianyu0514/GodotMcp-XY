...
[![Tools](https://img.shields.io/badge/MCP%20tools-202-blue.svg)](docs/tools/README.md)
...
- **202 tools, sensibly scoped** — 30 high-value *core* tools are on by default; 172 more
...
The plugin exposes **202 tools** in six categories. Each links to a full, per-tool reference.
...
Only the 30 **core** tools are enabled by default — enable any of the 172 **advanced** tools
