...
- **223 tools with a small default surface:** 29 core tools are enabled immediately, 190 advanced tools can be enabled on demand, and 4 meta tools are always available for tool discovery.
