...
- **234 tools with a small default surface:** 28 core tools are enabled immediately, 200 advanced tools remain on demand, and 6 meta tools cover discovery plus durable complete-game workflows.
...
| [Project](docs/tools/project-tools.md) | 70 | 3 | 67 | Settings, resources, input map, tests, migration scans, assets, TileSets, sprite/glTF workflows, task plans and localization |
