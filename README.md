...
[![Tools](https://img.shields.io/badge/MCP%20tools-206-blue.svg)](docs/tools/README.md)
...
- **206 tools, sensibly scoped** — 30 high-value *core* tools are on by default; 174 more
...
The plugin exposes **206 tools** in six categories (plus 2 always-on *meta* tools for tool discovery). Each links to a full, per-tool reference.
...
| [Project](docs/tools/project-tools.md) | 55 | Settings, resources, input map, audits, 4.7 migration, asset generation, task plan |
...
Only the 30 **core** tools (plus 2 always-on **meta** tools) are enabled by default — enable any of the 174 **advanced** tools
