...
- **215 tools with a small default surface:** 28 core tools are enabled immediately, 185 advanced tools can be enabled on demand, and 2 meta tools are always available for tool discovery.
...
| [Script](docs/tools/script-tools.md) | 17 | 6 | 11 | Read/write/validate GDScript and C#, shader validation, search, symbols and references |
...
| [Editor](docs/tools/editor-tools.md) | 24 | 3 | 21 | Run/stop, screenshots, selection, inspector state, export templates and script buffers |
