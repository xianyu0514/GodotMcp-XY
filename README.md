...
[![Tools](https://img.shields.io/badge/MCP%20tools-218-blue.svg)](docs/tools/README.md)
...
- **218 tools with a small default surface:** 28 core tools are enabled immediately, 186 advanced tools can be enabled on demand, and 4 meta tools are always available for tool discovery.
