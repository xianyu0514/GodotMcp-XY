...
- **235 个工具且默认面精简：** 28 个核心工具默认启用，201 个高级工具按需启用，另有 6 个常驻元工具负责发现、启用和完整游戏闭环。
...
| [Project](docs/tools/project-tools.md) | 72 | 3 | 69 | 设置、资源、输入映射、测试、迁移扫描、资产、TileSet、精灵表/glTF 和任务计划 |
