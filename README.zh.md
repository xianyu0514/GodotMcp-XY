...
- **234 个工具且默认面精简：** 28 个核心工具默认启用，200 个高级工具按需启用，另有 6 个常驻元工具负责发现、启用和完整游戏闭环。
...
| [Debug & Runtime](docs/tools/debug-tools.md) | 74 | 3 | 71 | 日志、调试器、性能分析、运行时探针、确定性游玩验证和回归门禁 |
| [Project](docs/tools/project-tools.md) | 71 | 3 | 68 | 设置、资源、输入映射、测试、迁移扫描、资产、TileSet、精灵表/glTF 和任务计划 |
