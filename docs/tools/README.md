...
Godot MCP Native registers **223 MCP tools**: 29 core tools, 190 advanced tools and 4 always-on meta tools. `addons/godot_mcp/native_mcp/tools_manifest.gd` is the source of truth for tier and group membership.
