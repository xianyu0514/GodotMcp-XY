...
Godot MCP Native registers **243 MCP tools**: 28 core tools, 209 advanced tools and 6 always-on meta tools. The manifest in `addons/godot_mcp/native_mcp/tools_manifest.gd` is the source of truth for tier and group membership.
...
| Scene | 14 | 4 | 10 | [scene-tools.md](scene-tools.md) |
| Editor | 27 | 3 | 24 | [editor-tools.md](editor-tools.md) |
| Debug & Runtime | 78 | 3 | 75 | [debug-tools.md](debug-tools.md) |
...
Existing-script edits additionally support unique text replacement and optional content-hash preconditions, and reject known unsaved target buffers. Invalid line edits preserve the file. Counts remain 243 tools (28 core, 209 advanced, 6 meta).
