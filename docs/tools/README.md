...
Godot MCP Native registers **231 MCP tools**: 28 core tools, 197 advanced tools and 6 always-on meta tools. The manifest in `addons/godot_mcp/native_mcp/tools_manifest.gd` is the source of truth for tier and group membership.
