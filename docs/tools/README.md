...
Godot MCP Native registers **225 MCP tools**: 30 core tools, 191 advanced tools and 4 always-on meta tools. `addons/godot_mcp/native_mcp/tools_manifest.gd` is the source of truth for tier and group membership.
...
| Debug & Runtime | 75 | 3 | 72 | [debug-tools.md](debug-tools.md) |
| Project | 63 | 5 | 58 | [project-tools.md](project-tools.md) |
