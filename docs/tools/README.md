...
Godot MCP Native registers **249 MCP tools**: 28 core tools, 215 advanced tools and 6 always-on meta tools. The manifest in `addons/godot_mcp/native_mcp/tools_manifest.gd` is the source of truth for tier and group membership.

## Category summary

| Category | Tools | Core | Advanced | Page |
| --- | ---: | ---: | ---: | --- |
| Node | 28 | 9 | 19 | [node-tools.md](node-tools.md) |
| Script | 18 | 6 | 12 | [script-tools.md](script-tools.md) |
| Scene | 16 | 4 | 12 | [scene-tools.md](scene-tools.md) |
| Editor | 28 | 3 | 25 | [editor-tools.md](editor-tools.md) |
| Debug & Runtime | 79 | 3 | 76 | [debug-tools.md](debug-tools.md) |
| Project | 74 | 3 | 71 | [project-tools.md](project-tools.md) |
...
Existing-script edits additionally support unique text replacement and optional content-hash preconditions, and reject known unsaved target buffers. Invalid line edits preserve the file. Counts remain 249 tools (28 core, 215 advanced, 6 meta).
