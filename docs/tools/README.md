...
The plugin exposes **212 MCP tools** to connected AI clients: 6 functional categories plus
...
(The 2 Meta tools are always-on and counted separately from the 30 core / 180 advanced split.)
...
- **Advanced** — the remaining 180 tools. They are registered but **disabled by default**
