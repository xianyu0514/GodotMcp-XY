...
Always-on discovery and orchestration tools. They keep the default tool list small while preserving all 217 atomic capabilities and complete multi-phase goals.
