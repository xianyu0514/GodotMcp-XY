...
func _build_classifications() -> void:
	var classifications: Array[Dictionary] = [
		...
		{"name": "execute_script", "category": "supplementary", "group": "Script"},
		{"name": "get_performance_metrics", "category": "supplementary", "group": "Debug-Advanced"},
		{"name": "debug_print", "category": "core", "group": "Debug"},
		{"name": "execute_editor_script", "category": "supplementary", "group": "Editor"},
		...
		{"name": "assert_performance_budget", "category": "supplementary", "group": "Debug-Advanced"},
		{"name": "assert_no_runtime_errors", "category": "supplementary", "group": "Debug-Advanced"},
		...
		{"name": "smoke_test_export", "category": "supplementary", "group": "Editor-Advanced"},
		...
		{"name": "undo", "category": "supplementary", "group": "Editor-Advanced"},
		{"name": "redo", "category": "supplementary", "group": "Editor-Advanced"},
		{"name": "get_undo_history", "category": "supplementary", "group": "Editor-Advanced"},
		...
		{"name": "assert_visual_baseline", "category": "supplementary", "group": "Project-Advanced"},
		...
		{"name": "generate_3d_asset", "category": "supplementary", "group": "Project-Advanced"},
		{"name": "bump_version", "category": "supplementary", "group": "Project-Advanced"},
