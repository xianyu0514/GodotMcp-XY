...
- `tools/` — the 238 registered MCP tools.
...
The addon registers 238 tools:

- 28 core tools enabled by default.
- 204 advanced tools registered but disabled until enabled from the panel or `enable_tools`.
