...
- `tools/` — the 243 registered MCP tools.
...
The addon registers 243 tools:

- 28 core tools enabled by default.
- 209 advanced tools registered but disabled until enabled from the panel or `enable_tools`.
