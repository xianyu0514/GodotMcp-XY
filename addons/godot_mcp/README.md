...
- `tools/` — the 249 registered MCP tools.
...
The addon registers 249 tools:

- 28 core tools enabled by default.
- 215 advanced tools registered but disabled until enabled from the panel or `enable_tools`.
