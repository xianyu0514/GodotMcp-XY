...
- `tools/` — the 233 registered MCP tools.
...
The addon registers 233 tools:

- 28 core tools enabled by default.
- 199 advanced tools registered but disabled until enabled from the panel or `enable_tools`.
