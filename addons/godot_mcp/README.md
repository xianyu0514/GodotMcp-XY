...
- `tools/` — the 234 registered MCP tools.
...
The addon registers 234 tools:

- 28 core tools enabled by default.
- 200 advanced tools registered but disabled until enabled from the panel or `enable_tools`.
