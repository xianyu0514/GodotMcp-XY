...
- `tools/` — the 242 registered MCP tools.
...
The addon registers 242 tools:

- 28 core tools enabled by default.
- 208 advanced tools registered but disabled until enabled from the panel or `enable_tools`.
