...
- `tools/` — the 248 registered MCP tools.
...
The addon registers 248 tools:

- 28 core tools enabled by default.
- 214 advanced tools registered but disabled until enabled from the panel or `enable_tools`.
