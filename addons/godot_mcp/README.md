...
- `tools/` — the 235 registered MCP tools.
...
The addon registers 235 tools:

- 28 core tools enabled by default.
- 201 advanced tools registered but disabled until enabled from the panel or `enable_tools`.
