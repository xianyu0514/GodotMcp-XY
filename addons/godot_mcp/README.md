...
- **206 MCP tools** in 6 categories (30 core enabled by default; 174 advanced, opt-in) plus 2 always-on meta tools for tool discovery (`list_tool_catalog`, `enable_tools`).
