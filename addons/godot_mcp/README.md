...
- `tools/` — the 218 registered MCP tools.
...
The addon registers 218 tools:

- 28 core tools enabled by default.
- 186 advanced tools registered but disabled until enabled from the panel or `enable_tools`.
