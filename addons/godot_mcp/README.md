...
- `tools/` — the 245 registered MCP tools.
...
The addon registers 245 tools:

- 28 core tools enabled by default.
- 211 advanced tools registered but disabled until enabled from the panel or `enable_tools`.
