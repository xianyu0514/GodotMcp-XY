...
- `tools/` — the 251 registered MCP tools.
...
The addon registers 251 tools:

- 28 core tools enabled by default.
- 217 advanced tools registered but disabled until enabled from the panel or `enable_tools`.
