...
- `tools/` — the 225 registered MCP tools.
...
The addon registers 225 tools:

- 30 core tools enabled by default.
- 191 advanced tools registered but disabled until enabled from the panel or `enable_tools`.
