...
- `tools/` — the 236 registered MCP tools.
...
The addon registers 236 tools:

- 28 core tools enabled by default.
- 202 advanced tools registered but disabled until enabled from the panel or `enable_tools`.
