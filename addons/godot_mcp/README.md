...
- `tools/` — the 232 registered MCP tools.
...
The addon registers 232 tools:

- 28 core tools enabled by default.
- 198 advanced tools registered but disabled until enabled from the panel or `enable_tools`.
