...
- `tools/` — the 244 registered MCP tools.
...
The addon registers 244 tools:

- 28 core tools enabled by default.
- 210 advanced tools registered but disabled until enabled from the panel or `enable_tools`.
