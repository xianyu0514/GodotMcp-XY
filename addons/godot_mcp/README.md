...
- `tools/` — the 241 registered MCP tools.
...
The addon registers 241 tools:

- 28 core tools enabled by default.
- 207 advanced tools registered but disabled until enabled from the panel or `enable_tools`.
